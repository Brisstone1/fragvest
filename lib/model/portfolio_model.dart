class PortfolioModel {
  ...
  PortfolioModel({this.success, this.data});
...
class Data {
  ...
  Data({this.assetAllocation, this.properties});

  Data.fromJson(Map<String, dynamic> json) {
    if (json["asset_allocation"] is Map)
      this.assetAllocation = json["asset_allocation"] == null
          ? null
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.assetAllocation != null)
      data["asset_allocation"] = this.assetAllocation.toJson();
...
class Report {
  ...
  double currentNetYieldPercentage;
  ...
  Report.fromJson(Map<String, dynamic> json) {
    ...
    if (json["current_net_yield_percentage"] is double)
    ...
    if (json["days_left"] is int) this.daysLeft = json["days_left"];
...
class AssetAllocation {
  ...
  AssetAllocation({this.invested, this.rented, this.owned});

  AssetAllocation.fromJson(Map<String, dynamic> json) {
    if (json["invested"] is num) this.invested = json["invested"];
    if (json["rented"] is num) this.rented = json["rented"];
    if (json["owned"] is num) this.owned = json["owned"];
  }
