...
import 'package:fragvest_mobile/widget/other_rsi_detail.dart';
...
class RentSaleInvestDetail extends StatefulWidget {
  final rsi.Data property;
  // static const routeName = '/RentSaleInvest-detail';
  const RentSaleInvestDetail(this.property, {Key key}) : super(key: key);

  @override
  State<RentSaleInvestDetail> createState() => _RentSaleInvestDetailState();
}

class _RentSaleInvestDetailState extends State<RentSaleInvestDetail> {
  ...
  @override
  void initState() {
    _showImageUrl = widget.property.propertyImages[0];
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    // String _showImageUrl = _propertyDetial.propertyImages[0];
    return Scaffold(
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Text('Fragvest ID: ${widget.property.tokenId}',
                  ...
                  // if (widget.property.type == 'invest')
                  //   _displayPostion('Invest', kc2F54C6),
                  // if (widget.property.type == 'invest')
                  //   displayRightPostion('${widget.property.roi}% p.a', kcWhite),
                  // if (widget.property.negotiable == '1')
            ...
            centerTitle: false,
            actions: [
              _isInWatchlist(widget.property.inWatchlist, widget.property.id)
              // _isfavourite
              //     ? _checkWatchList(imgReadHeart)
              //     : _checkWatchList(imgBlackHeart,
              //         callback: () => _addToWatchList(_propertyDetial.id))
            ],
          ),
          _allBuildinWidget(widget.property.propertyImages),
          // AllBuildingWidget(propertyImages: ),
          OtherRSIDetails(),
        ],
      ),
    );
